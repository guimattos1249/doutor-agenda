...
const formSchema = z
  .object({
    ...
    appointmentPrice: z
      .number()
      .min(1, { message: "Preço da consultaé obrigatório" }),
      ...
      <Form {...form}>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Especialiade</FormLabel>
                <Select
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Preco da Consulta</FormLabel>
                <NumericFormat
                  value={field.value}
                  onValueChange={(value) => {
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Horário inicial de atendimento</FormLabel>
                <Select
                  onValueChange={field.onChange}
                  defaultValue={field.value}
                >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Horário final de atendimento</FormLabel>
                <Select
                  onValueChange={field.onChange}
                  defaultValue={field.value}
                >
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      Esta ação é irreversível. Isso irá deletar o médico em
