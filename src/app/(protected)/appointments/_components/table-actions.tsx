...
export function AppointmentsTableActions({
  ...
  const [upsertAppointmentDialogIsOpen, setUpsertAppointmentDialogIsOpen] =
    useState(false);
  ...
  return (
    <Dialog
      open={upsertAppointmentDialogIsOpen}
      onOpenChange={setUpsertAppointmentDialogIsOpen}
    >
      <DropdownMenu>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  ...
                  agendamento e todas as consultas agendadas.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
